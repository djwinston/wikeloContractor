...
2. At the energy core, connect **beam 1** to set the experiment number to **1**.
3. Collect the experiment data in the **medical office**, the room with the endless Sam respawn, to lock the **RGL** series.
4. Finish the experiment and collect **RCMBNT-RGL-1**.
